...
<div class="wpum-template wpum-form wpum-login-form">
	...
	<h2 class="wpum-login-title"><?php esc_html_e( 'Welcome Back', 'wp-user-manager' ); ?></h2>
	<p class="wpum-login-subtitle"><?php esc_html_e( 'Sign in to your account', 'wp-user-manager' ); ?></p>
