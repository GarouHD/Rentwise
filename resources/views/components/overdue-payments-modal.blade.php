...
>
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl transform transition-all duration-300 scale-100 max-h-[90vh] flex flex-col">
    ...
    <div class="flex items-center justify-between border-b border-slate-200 px-4 sm:px-6 py-3 sm:py-4 gap-2">
      <div>
        <h2 class="text-base sm:text-lg font-semibold text-slate-800">Overdue Payments</h2>
        <p class="text-xs sm:text-sm text-slate-500 mt-1">Tenants with outstanding payments</p>
      </div>
      <button type="button" onclick="hideOverduePayments()" class="text-slate-500 hover:text-slate-700 text-xl flex-shrink-0">✕</button>
    </div>
